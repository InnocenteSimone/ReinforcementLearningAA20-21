...
for episode in range(train_episodes):
    ...
    for step in range(max_steps): 
        ...
        if random.uniform(0, 1) > agent.getEpsilon():
            ...
            #action = np.argmax(agent.getAction_in_state(state)) #Exploitation
...
#Now we test the performance of the Q-table
...
print("Mean score over time: " + str(sum(rewards) / test_episodes))
